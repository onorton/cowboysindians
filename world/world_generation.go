...
func GenerateWorld(filename string) (*player.Player, []*npc.Mount, []*npc.Npc) {
	...
	mounts := generateMounts(world, buildings, worldmap.WorldConf.Mounts)
	enemies := generateEnemies(world, worldmap.WorldConf.Enemies)
	npcs := generateNpcs(world, towns, buildings, worldmap.WorldConf.Npcs)

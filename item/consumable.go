...
func NewConsumable(name string) *Item {
	...
	return &Item{name, "", consumable.Icon, consumable.Weight, consumable.Value, map[string]component{"consumable": ConsumableComponent{consumable.Effects}}, nil, nil, nil}
}
